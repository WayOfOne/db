...
| Trade | `Trade.isOpen/accept/decline/tradeWith(name)` (both stages) |
| Deposit box | `DepositBox.isOpen/open(ids...)/depositAllItems/depositAllEquipment/depositAllLoot/close/slotWidget` |
